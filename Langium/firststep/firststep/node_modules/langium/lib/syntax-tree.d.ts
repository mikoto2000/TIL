...
export declare function isCompositeCstNode(node: CstNode): node is CompositeCstNode;
/**
...
export declare function isLeafCstNode(node: CstNode): node is LeafCstNode;
