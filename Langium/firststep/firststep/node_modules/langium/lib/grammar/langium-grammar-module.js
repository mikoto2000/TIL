...
const langium_grammar_scope_1 = require("./langium-grammar-scope");
const langium_grammar_semantic_token_provider_1 = require("./langium-grammar-semantic-token-provider");
...
exports.LangiumGrammarModule = {
    ...
    lsp: {
        ...
        SemanticTokenProvider: () => new langium_grammar_semantic_token_provider_1.LangiumGrammarSemanticTokenProvider()
    },
    references: {
        ScopeComputation: (services) => new langium_grammar_scope_1.LangiumGrammarScopeComputation(services),
        ScopeProvider: (services) => new langium_grammar_scope_1.LangiumScopeProvider(services)
    }
};
