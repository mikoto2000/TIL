...
public class BulkInsertMain {

    public static void main(String[] args)
        throws AsyncApiException, ConnectionException, IOException {
        BulkInsertExample example = new BulkInsertExample();
        ...
        String[] inputDataArray = {objectName, dataPath, userName, password};
        ...
        example.runSample(objectName, userName, password, dataPath);
    }
}
